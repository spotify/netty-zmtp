...
import com.spotify.netty4.handler.codec.zmtp.VerifyingDecoder2.ExpectedOutput;
...
/**
 * This test attempts to thoroughly exercise the {@link ZMTPMessageParser2} by feeding it input
...
public class ZMTPMessageParser2Test {
  ...
  private void testParse(final List<String> input, final int version)
    ...
    {
      final VerifyingDecoder2 verifier = new VerifyingDecoder2(expected);
      final ZMTPMessageParser2 parser = ZMTPMessageParser2.create(version, verifier);
    ...
    final VerifyingDecoder2 verifier = new VerifyingDecoder2();
    final ZMTPMessageParser2 parser = ZMTPMessageParser2.create(version, verifier);
